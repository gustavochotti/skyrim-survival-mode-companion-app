# -*- coding: utf-8 -*-
# Ingredients and their four effects.
# Source: Guia_Alquimia.pdf (user-provided)
...
INGREDIENTS = {
    ...
    "Berit's Ashes": ["Damage Stamina", "Resist Fire", "Fortify Conjuration", "Ravage Stamina"],
    ...
    "Fine-Cut Void Salts": ["Weakness to Shock", "Resist Magic", "Damage Health", "Fortify Magicka"],
...
ALL_EFFECTS = sorted({e for effects in INGREDIENTS.values() for e in effects})

# Mapeamento de efeito → ingredientes que o possuem
EFFECT_TO_INGREDIENTS = {effect: [] for effect in ALL_EFFECTS}
for ingredient, effects in INGREDIENTS.items():
    for effect in effects:
        EFFECT_TO_INGREDIENTS[effect].append(ingredient)
